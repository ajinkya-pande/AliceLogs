...
def print_event_message(self, time, author_name, message):
    ...
    try:
        if contains_bad_word:
            ...
            print(Fore.GREEN + f"{time} - {Fore.BLUE}[DISCORD]{Fore.RESET}{Fore.GREEN} {filtered_author_name} {message}" + Fore.RESET)
        elif author_name.name in hidden_users(self):  # Compare with the list of hidden usernames
            print(Fore.GREEN + f"{time} - {Fore.BLUE}[DISCORD]{Fore.RESET}{Fore.GREEN} Hidden {message}" + Fore.RESET)
        else:
            print(Fore.GREEN + f"{time} - {Fore.BLUE}[DISCORD]{Fore.RESET}{Fore.GREEN} {author_name.name} {message}" + Fore.RESET)
